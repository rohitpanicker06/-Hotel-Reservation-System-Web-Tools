...
<html>
    ...
    <body>
        ...
        <script>
            $(function () {
                var checkinDateInput = $('.date-picker[name="date"]');
                var checkoutDateInput = $('.date-picker[name="outdate"]');

                checkinDateInput.datepicker({
                    onSelect: function (selectedDate) {
                        var minDate = new Date(selectedDate);
                        minDate.setDate(minDate.getDate() + 1); // Add one day to the selected date
                        checkoutDateInput.datepicker("option", "minDate", minDate);
                    }
                });
